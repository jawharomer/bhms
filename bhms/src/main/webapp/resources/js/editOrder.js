...
appEditOrder = angular.module("editOrder", []);

appEditOrder.factory('httpRequestInterceptor', function() {
	return {
...
appEditOrder.config(function($httpProvider) {
